...
function generateSearchTerms(segment: string): string[] {
  ...
  const categoryTerms: { [key: string]: string[] } = {
    ...
    'distribuidores de refrigerantes': ['distribuidora de refrigerantes', 'refrigerantes', 'distribuidor de refrigerantes', 'distribuidores de refrigerantes', 'distribuidoras de refrigerantes'],
    'distribuidores de cervejas': ['distribuidora de cervejas', 'cervejas', 'distribuidor de cervejas', 'distribuidores de cervejas', 'distribuidoras de cervejas'],
    ...
    'empresas de automação comercial': ['automacao', 'automacao comercial', 'pdv', 'sistema para comercio'],
    ...
    'empresas de instalação de gnv': ['gnv', 'gnv', 'gas natural veicular', 'kit gnv'],
