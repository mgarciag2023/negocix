...
function generateSearchTerms(segment: string): string[] {
  ...
  const categoryTerms: { [key: string]: string[] } = {
    ...
    'lojas de cama, mesa e banho': ['cama mesa banho', 'enxoval', 'loja de cama', 'loja de banho', 'toalhas', 'lençóis', 'edredom', 'colchas', 'enxovais'],
    'lojas de utilidades domésticas': ['utilidades domésticas', 'casa e cozinha', 'utilidades para casa', 'bazar', 'loja de utilidades', 'artigos para casa', 'loja de panelas', 'artigos domésticos'],
    'lojas de utilidades': ['loja de utilidades', 'bazar', '1,99', 'loja de 1 real', 'utilidades gerais', 'variedades', 'loja de variedades'],
