...
function generateSearchTerms(segment: string): string[] {
  ...
  const categoryTerms: { [key: string]: string[] } = {
    ...
    'vidraçarias': ['vidracaria', 'vidraçaria', 'vidracarias', 'vidraçarias', 'vidros', 'vidro', 'espelhos', 'espelho', 'box de vidro', 'box para banheiro', 'box blindex', 'blindex', 'vidro temperado', 'vidros temperados', 'vidracaria e espelhos', 'porta de vidro', 'portas de vidro', 'janela de vidro', 'janelas de vidro', 'fachada de vidro', 'pele de vidro', 'cobertura de vidro', 'guarda corpo de vidro', 'guarda-corpo de vidro', 'corrimao de vidro', 'corrimão de vidro', 'sacada de vidro', 'envidracamento', 'envidraçamento', 'instalacao de vidros', 'instalação de vidros', 'troca de vidros', 'corte de vidros', 'beneficiamento de vidros', 'tampo de vidro', 'mesa de vidro', 'prateleira de vidro', 'vitrine de vidro', 'box de banheiro', 'fechamento de sacada', 'kit box', 'vidracaria 24 horas', 'vidracaria 24h', 'vidracaria express'],
    ...
    'postos de combustível': ['posto de combustivel', 'posto de combustível', 'postos de combustivel', 'postos de combustível', 'posto de gasolina', 'postos de gasolina', 'combustiveis', 'combustíveis', 'combustivel', 'combustível', 'auto posto', 'autoposto', 'auto-posto', 'posto shell', 'posto ipiranga', 'posto petrobras', 'posto br', 'posto ale', 'posto raizen', 'posto graal', 'posto de etanol', 'posto de alcool', 'posto de álcool', 'posto de diesel', 'posto de gnv', 'gnv', 'gas natural veicular', 'gás natural veicular', 'posto bandeirado', 'posto bandeira branca', 'posto rodoviario', 'posto rodoviário', 'posto urbano', 'rede de postos', 'posto 24 horas', 'posto 24h', 'posto e conveniencia', 'posto e conveniência', 'conveniencia posto', 'loja de conveniencia posto', 'lubrificacao posto', 'troca de oleo posto', 'troca de óleo posto', 'distribuidora de combustiveis varejo', 'revenda de combustiveis', 'revenda de combustíveis', 'posto multi-bandeira', 'posto multibandeira'],
    ...
    'distribuidores de água': ['distribuidora de agua', 'distribuidora de água', 'distribuidor de agua', 'distribuidor de água', 'distribuidoras de agua', 'distribuidoras de água', 'agua mineral', 'água mineral', 'agua mineral natural', 'água mineral natural', 'galao de agua', 'galão de água', 'galao 20 litros', 'galão 20 litros', 'galao 20l', 'galão 20l', 'agua 20 litros', 'água 20 litros', 'entrega de agua', 'entrega de água', 'tele agua', 'tele água', 'distribuidora de galao', 'distribuidora de galão', 'fornecedor de agua mineral', 'fornecedor de água mineral', 'agua de bebedouro', 'água de bebedouro', 'agua engarrafada', 'água engarrafada', 'depósito de agua', 'deposito de agua', 'distribuidor de agua e gas', 'distribuidor de água e gás', 'água e gás', 'agua e gas', 'distribuidora de agua mineral', 'distribuidora de água mineral', 'agua mineral em domicilio', 'água mineral em domicílio', 'venda de agua mineral', 'venda de água mineral', 'agua de coco', 'água de coco distribuidora'],
    ...
    'empresas de limpeza': ['empresa de limpeza', 'empresas de limpeza', 'limpeza', 'limpeza profissional', 'limpeza comercial', 'limpeza industrial', 'limpeza condominial', 'limpeza pos obra', 'limpeza pós obra', 'limpeza pesada', 'limpeza terceirizada', 'conservacao', 'conservação', 'conservacao e limpeza', 'conservação e limpeza', 'servicos de limpeza', 'serviços de limpeza', 'prestadora de servicos de limpeza', 'prestadora de serviços de limpeza', 'higienizacao', 'higienização', 'higienizacao de estofados', 'higienização de estofados', 'limpeza de carpetes', 'limpeza de sofas', 'limpeza de sofás', 'limpeza de vidros', 'limpeza de fachadas', 'limpeza de caixa dagua', 'limpeza de caixa d agua', 'limpeza de caixa d\'água', 'limpeza de piscinas', 'limpeza de escritorios', 'limpeza de escritórios', 'mao de obra para limpeza', 'mão de obra para limpeza', 'asseio e conservacao', 'asseio e conservação', 'terceirizacao de limpeza', 'terceirização de limpeza', 'limpeza hospitalar', 'limpeza de obras', 'faxina profissional', 'diarista empresarial', 'limpeza diaria', 'limpeza diária', 'gerenciamento de limpeza'],
    ...
    'distribuidoras de equipamentos médicos': ['distribuidora de equipamentos medicos', 'distribuidora de equipamentos médicos', 'distribuidor de equipamentos medicos', 'distribuidor de equipamentos médicos', 'equipamentos medicos', 'equipamentos médicos', 'aparelhos medicos', 'aparelhos médicos', 'equipamentos hospitalares', 'distribuidora de equipamentos hospitalares', 'distribuidor de equipamentos hospitalares', 'equipamentos para hospitais', 'equipamentos para clinicas', 'equipamentos para clínicas', 'equipamentos para consultorios', 'equipamentos para consultórios', 'instrumentos cirurgicos', 'instrumentos cirúrgicos', 'instrumental medico', 'instrumental médico', 'instrumental hospitalar', 'distribuidora de instrumental medico', 'distribuidora de instrumental cirurgico', 'mobiliario hospitalar', 'mobiliário hospitalar', 'macas hospitalares', 'maca hospitalar', 'cama hospitalar', 'camas hospitalares', 'monitores multiparametricos', 'monitor multiparametro', 'eletrocardiografo', 'eletrocardiógrafo', 'desfibrilador', 'oximetro', 'oxímetro', 'esfigmomanometro', 'esfigmomanômetro', 'estetoscopio', 'estetoscópio', 'autoclave', 'distribuidora de autoclaves', 'foco cirurgico', 'foco cirúrgico', 'mesa cirurgica', 'mesa cirúrgica', 'distribuidora produtos hospitalares', 'fornecedor de equipamentos medicos', 'fornecedor de equipamentos médicos', 'representante de equipamentos hospitalares', 'aparelhos hospitalares', 'equipamentos de diagnostico', 'equipamentos de diagnóstico', 'equipamentos de uti', 'equipamentos para uti', 'aparelhos de fisioterapia', 'equipamentos odontologicos', 'equipamentos odontológicos'],
