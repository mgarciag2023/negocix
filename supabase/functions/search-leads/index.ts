...
function generateSearchTerms(segment: string): string[] {
  ...
  const categoryTerms: { [key: string]: string[] } = {
    ...
    'clínicas médicas e odontológicas': ['clinica medica', 'clinica odontologica', 'consultorio medico', 'consultorio odontologico', 'policlinica odonto', 'clinica multipla', 'consultorio medico odonto', 'centro clinico odonto', 'centro clinico medico dental', 'clinica saude bucal e medica'],
    ...
    'planos de saúde': ['plano de saude', 'operadora de saude', 'convenio medico', 'saude suplementar', 'assistencia medica', 'assistência médica', 'seguro saude', 'seguro saúde', 'convenio medico empresa', 'plano medico', 'operadora de planos'],
    'home care': ['home care', 'atendimento domiciliar', 'enfermagem domiciliar', 'cuidado domiciliar', 'internacao domiciliar', 'internação domiciliar', 'enfermagem em casa', 'saude em casa', 'saúde em casa', 'home health care', 'atencao domiciliar', 'atenção domiciliar'],
    ...
    'empresas de engenharia elétrica': ['engenharia eletrica', 'projeto eletrico', 'instalacoes eletricas', 'projeto de eletrica', 'projeto elétrico industrial', 'engenharia de instalacoes eletricas', 'instalacoes eletricas industriais', 'projeto eletrico predial', 'eletrica predial projeto', 'engenheiro eletricista empresa'],
    ...
    'autopeças de importados': ['autopecas importados', 'pecas importadas', 'pecas carro importado', 'autopecas importadas', 'pecas para importados', 'import car parts', 'autopecas import', 'import car pecas', 'pecas para importado', 'pecas de luxo', 'pecas premium automotivas', 'pecas para veiculos importados', 'autopecas premium importadas'],
    ...
    'cooperativas agrícolas': ['cooperativa agricola', 'cooperativa rural', 'cooperativa de produtores', 'cooperativa agro', 'coop agricola', 'cooperativa de agricultores', 'coop rural', 'cooperativa rural produtores'],
    ...
    'lojas de tecidos para decoração': ['tecidos para decoracao', 'tecidos decorativos', 'tecidos decorativos loja', 'loja de cortinas tecidos', 'tecidos para estofado', 'tecidos para cortina loja', 'casa de tecidos decorativos'],
    ...
    'lojas de colchões terapêuticos': ['colchao terapeutico', 'colchao ortopedico', 'colchao magnetico', 'colchao magnetico loja', 'colchao ortopedico loja', 'colchoes terapeuticos', 'colchão terapêutico loja', 'colchoes ortopedicos loja', 'cama terapeutica loja', 'colchao saude loja'],
    ...
    'açougues gourmet': ['acougue gourmet', 'boutique de carnes', 'carnes nobres', 'carnes premium', 'casa de carnes premium', 'boutique de carnes gourmet', 'acougue premium', 'açougue premium', 'carnes especiais', 'casa de cortes nobres', 'acougue de carnes nobres', 'casa de carnes gourmet', 'boutique carnes especiais'],
    ...
    'arenas de beach tennis': ['beach tennis', 'arena de beach', 'quadra de beach', 'arena beach', 'quadra beach tennis', 'clube de beach', 'centro de beach tennis', 'beach arena', 'quadra de areia beach', 'complexo de beach tennis', 'arena esportiva beach'],
    'quadras de tênis': ['quadra de tenis', 'tenis', 'clube de tenis'],
    'clubes esportivos': ['clube esportivo', 'clube recreativo', 'clube social', 'associacao esportiva', 'clube social esportivo', 'associacao desportiva', 'associação desportiva', 'centro de lazer', 'clube de campo', 'clube aquatico', 'clube aquático', 'centro esportivo social', 'clube de lazer esportivo', 'associacao esportiva social'],
    ...
    'empresas com frota própria': ['frota propria', 'frota corporativa', 'gestao de frotas', 'gestão de frotas', 'frota de veiculos', 'frota de veículos', 'empresa com veiculos proprios', 'gestao de veiculos corporativos'],
    ...
    'empresas de portaria remota': ['portaria remota', 'portaria virtual', 'portaria automatizada', 'portaria inteligente', 'controle de acesso remoto', 'portaria digital', 'controle de acesso predial', 'portaria sem presenca'],

    // ===== MARKETING E PUBLICIDADE =====
    'agências de marketing digital': ['agencia de marketing', 'marketing digital', 'agencia digital', 'digital agency', 'agencia de performance', 'agência de performance', 'marketing online empresa', 'gestao de trafego', 'gestão de tráfego', 'marketing empresa digital', 'empresa de marketing online', 'performance digital empresa'],
    ...
    'agências de mídias sociais': ['midias sociais', 'redes sociais', 'social media', 'gestao de redes sociais', 'gestão de redes sociais', 'social media marketing', 'agencia de social', 'agência de social', 'gestao social media', 'empresa de social media', 'administracao de redes sociais'],
    ...
    // ===== EVENTOS =====
    'agência de eventos': ['agencia de eventos', 'organizadora de eventos', 'produtora de eventos', 'buffet e eventos', 'eventos corporativos empresa', 'empresa de eventos', 'promotora de eventos', 'gestora de eventos', 'producao de eventos', 'produção de eventos', 'produtora de eventos corporativos', 'empresa organizadora de eventos', 'eventos empresa'],
    'buffets de festas': ['buffet de festas', 'buffet infantil', 'espaco para eventos', 'salao de festas', 'buffet eventos', 'espaco infantil', 'espaço infantil', 'casa de festas buffet', 'buffet casamento', 'buffet corporativo', 'espaco de eventos', 'espaço de eventos', 'espaco para festas buffet', 'festa e buffet', 'buffet para aniversario', 'buffet para casamento'],
    'casas de festas': ['casa de festas', 'salao de festas', 'espaco para eventos', 'espaco de festas', 'espaço de festas', 'chacara de festas', 'chácara de festas', 'sitio de festas', 'sítio de festas', 'espaco evento', 'espaço evento', 'local para festas', 'espaco para aniversario', 'espaço para aniversário'],
    'empresas de locação de materiais para eventos': ['locacao de materiais', 'mesas e cadeiras', 'toalhas para eventos', 'locacao de mesas', 'locação de mesas', 'aluguel de cadeiras', 'locacao de tendas', 'locação de tendas', 'aluguel para festas', 'aluguel de equipamentos para festas', 'locacao de tendas e cadeiras', 'aluguel de estruturas para eventos'],
    ...
    'lojas de artigos para bebê': ['artigos para bebe', 'loja de bebe', 'enxoval de bebe', 'baby shop', 'bebe store', 'bebê store', 'mundo do bebe', 'mundo do bebê', 'boutique de bebe', 'boutique de bebê', 'loja para recem-nascido', 'loja para recém-nascido', 'casa do bebe', 'casa do bebê'],
    ...
    'lojas de veículos elétricos': ['veiculos eletricos', 'patinete eletrico', 'bicicleta eletrica', 'patinete eletrico loja', 'bicicleta eletrica loja', 'mobilidade eletrica', 'mobilidade elétrica', 'bike eletrica', 'scooter eletrica loja', 'mobilidade urbana loja', 'loja de eletromobilidade'],
    ...
    // ===== ENGENHARIA =====
    'empresas de engenharia mecânica': ['engenharia mecanica', 'projeto mecanico', 'projetos mecanicos empresa', 'consultoria mecanica', 'engenharia de maquinas', 'mecanica de projetos empresa', 'empresa de projetos mecanicos', 'engenharia industrial mecanica'],
    'empresas de engenharia ambiental': ['engenharia ambiental', 'meio ambiente', 'licenciamento ambiental', 'consultoria ambiental', 'gestao ambiental', 'gestão ambiental', 'estudo de impacto ambiental', 'meio ambiente empresa', 'consultoria ambiental empresa', 'licenciamento ambiental empresa'],
    ...
    'escolas particulares': ['escola particular', 'colegio particular', 'escola privada', 'colegio privado', 'colégio privado', 'instituicao de ensino privada', 'instituição de ensino privada', 'instituicao de ensino particular', 'escola premium', 'ensino particular'],
    ...
    'cabeleireiros infantis': ['cabeleireiro infantil', 'salao infantil', 'salao kids', 'salão kids', 'hair kids', 'corte infantil', 'cabeleireiro kids', 'barbearia infantil', 'corte para criancas', 'corte para crianças', 'beauty kids'],
    ...
    'hotéis fazenda': ['hotel fazenda', 'fazenda hotel', 'turismo rural', 'fazenda turistica', 'fazenda turística', 'turismo rural hotel', 'pousada rural', 'hotel rural', 'pousada fazenda', 'resort rural', 'fazenda turismo'],
    'motéis': ['motel'],
    ...
    'casas de show': ['casa de show', 'casa de espetaculos', 'espaco de shows', 'espaço de shows', 'palco para eventos', 'casa de eventos musicais', 'venue musical', 'venue de eventos', 'espaco musical', 'espaço musical'],
    'cinemas': ['cinema', 'multiplex', 'sala de cinema'],
    'parques aquáticos': ['parque aquatico', 'toboagua', 'piscinas'],
    'parques de diversões': ['parque de diversoes', 'parque tematico', 'parque de aventuras', 'parque recreativo', 'entretenimento familiar', 'diversao familiar', 'diversão familiar', 'parque recreativo infantil'],
    'pesque e pague': ['pesque e pague', 'pesqueiro', 'pesca'],
    'bowling': ['bowling', 'boliche'],
    'karting': ['karting', 'kart', 'kartódromo'],
    'escape rooms': ['escape room', 'sala de fuga', 'sala de escape', 'jogo de fuga', 'escape game', 'adventure room', 'jogo de escape', 'mystery room', 'sala de enigmas'],
    ...
    'beneficiadoras de café': ['beneficiadora de cafe', 'beneficiamento de cafe', 'beneficiamento de cafe industrial', 'torrefacao e beneficiamento', 'cooperativa de cafe', 'processadora de cafe', 'torrefacao cafe', 'beneficio cafe industrial'],
    ...
    'lojas de artigos religiosos': ['artigos religiosos', 'loja religiosa', 'imagenes sacras', 'loja sacra', 'artigos sacros', 'loja de santos', 'imagenes religiosas', 'produtos sacros loja', 'loja de artigos catolicos', 'artigos para igrejas'],
    ...
    // ===== ESCOLAS FALTANTES =====
    'escolas bilíngues': ['escola bilingue', 'educacao bilingue', 'escola internacional', 'escola bilingual', 'colegio bilingue', 'colégio bilíngue', 'ensino bilingue', 'school bilingual', 'colegio internacional', 'escola international', 'escola bilingual education'],
    ...
    'dark kitchens': ['dark kitchen', 'cozinha fantasma', 'cloud kitchen', 'ghost kitchen', 'kitchen fantasma', 'virtual kitchen', 'cozinha virtual', 'delivery only', 'restaurante virtual', 'cozinha delivery', 'restaurante delivery only', 'kitchen cloud'],
    'casas de chá': ['casa de cha', 'cha', 'tea house'],
    'cafés especiais': ['cafe especial', 'cafe gourmet', 'specialty coffee', 'coffee shop gourmet', 'micro torrefacao', 'micro torrefação', 'cafe artesanal', 'café artesanal', 'specialty coffee shop', 'torrefacao especial', 'torrefação especial'],
    ...
    'lojas de chocolates belgas': ['chocolates belgas', 'chocolates importados', 'chocolate premium', 'chocolatier premium', 'loja de chocolates finos', 'chocolate artesanal premium', 'chocolatier fino', 'chocolate gourmet loja'],
    'importadoras de vinhos': ['importadora de vinhos', 'vinhos importados', 'wine importer', 'vinhos importados loja', 'wine shop importados', 'adega de importados', 'importacao de vinhos', 'adega de vinhos importados'],
    ...
    'empresas de pesquisa de mercado': ['pesquisa de mercado', 'instituto de pesquisa', 'market research', 'analise de mercado', 'análise de mercado', 'inteligencia de mercado', 'inteligência de mercado', 'pesquisa e inteligencia', 'dados de mercado empresa', 'analytics de mercado'],
    ...
    'laboratórios veterinários': ['laboratorio veterinario', 'exames veterinarios', 'lab vet', 'diagnostico veterinario', 'diagnóstico veterinário', 'patologia veterinaria', 'laboratorio de analises veterinarias', 'diagnostico animal lab'],
