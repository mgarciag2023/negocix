...
function generateSearchTerms(segment: string): string[] {
  ...
  const categoryTerms: { [key: string]: string[] } = {
    ...
    'distribuidores de colchões': ['distribuidora de colchoes', 'colchoes atacado', 'colchoes para revenda', 'atacadista de colchoes', 'colchoes atacadista'],
    ...
    'distribuidoras de alimentos para food service': ['distribuidora de alimentos', 'food service', 'atacadista de alimentos', 'distribuidor food service', 'refeicao coletiva', 'atacadista food service', 'distribuidor para restaurantes', 'fornecedor para cozinha industrial'],
    'distribuidoras de alimentos': ['distribuidora de alimentos', 'atacadista de alimentos', 'comercio atacadista de produtos alimenticios', 'generos alimenticios', 'atacadista alimenticio', 'atacadista alimentício', 'comercio atacadista alimentar', 'distribuidor de mantimentos', 'distribuidora de generos alimenticios', 'comercio atacadista de alimentos', 'atacado alimentar'],
    'distribuidoras de carnes': ['distribuidora de carnes', 'atacado de carnes', 'atacadista de carnes', 'frigorifico'],
    'distribuidoras de congelados': ['distribuidora de congelados', 'congelados atacado', 'atacadista de congelados', 'atacado de congelados', 'fornecedor de congelados', 'congelados para restaurantes'],
    'distribuidoras de sorvetes': ['distribuidora de sorvetes', 'sorvetes atacado', 'atacadista de sorvetes', 'atacado de sorvetes', 'fornecedor de sorvete', 'sorvetes para revenda'],
    'distribuidoras de açaí': ['distribuidora de acai', 'acai atacado', 'atacadista de acai', 'fornecedor de acai', 'acai para revenda', 'polpa de acai atacado'],
    'distribuidoras de polpas de frutas': ['distribuidora de polpas', 'polpa de fruta', 'atacadista de polpas', 'polpas atacado', 'fornecedor de polpas', 'polpas para suco atacado'],
    'distribuidoras de ovos': ['distribuidora de ovos', 'ovos atacado', 'granja distribuidora', 'atacadista de ovos', 'granja de ovos atacado', 'distribuidor de ovos de galinha', 'ovos para revenda', 'ovos de galinha atacado', 'ovos para padaria', 'ovos caipira atacado'],
    ...
    'distribuidoras de material hospitalar': ['material hospitalar', 'material medico', 'produtos hospitalares', 'equipamentos hospitalares distribuidor', 'insumos hospitalares atacado', 'material medico distribuidor'],
    'distribuidoras de produtos hospitalares': ['material hospitalar', 'produtos hospitalares', 'insumos hospitalares fornecedor', 'produtos medicos distribuidor', 'descartaveis hospitalares atacado'],
    ...
    'distribuidores de material médico hospitalar': ['material medico', 'material hospitalar', 'fornecedor de equipamentos medicos', 'insumos medicos distribuidor', 'material cirurgico atacado'],
    ...
    'distribuidoras de frios': ['distribuidora de frios', 'frios e embutidos', 'frios atacado', 'atacadista de frios', 'frios e embutidos distribuidor', 'atacado de frios e embutidos', 'distribuidora de presunto e queijo', 'distribuidor de frios para restaurante'],
    'distribuidoras de laticínios': ['distribuidora de laticinios', 'laticinios atacado', 'atacadista de laticinios'],
    'distribuidoras de pescados': ['distribuidora de pescados', 'pescado atacado', 'frutos do mar atacado', 'peixe atacado', 'atacadista de pescados', 'distribuidor de peixe fresco', 'frutos do mar distribuidor', 'distribuidor de camarao'],
