...
function getCnaesForSegment(segment: string): string[] {
  ...
  const cnaeMap: { [key: string]: string[] } = {
    ...
    // ============= LOTE 5 — MODA, VESTUÁRIO & VAREJO GERAL =============
    'lojas de roupas': ['4781400'],
    'lojas de roupas femininas': ['4781400'],
    'lojas de roupas masculinas': ['4781400'],
    'lojas de roupas infantis': ['4781400'],
    'moda infantil': ['4781400'],
    'moda feminina': ['4781400'],
    'moda masculina': ['4781400'],
    'moda praia': ['4781400'],
    'moda fitness': ['4781400'],
    'moda íntima': ['4781400'],
    'lingerie': ['4781400'],
    'lojas de calçados': ['4782201', '4782202'],
    'calçados': ['4782201', '4782202'],
    'lojas de acessórios': ['4783101', '4783102', '4789099'],
    'bijuterias': ['4783102'],
    'joalherias': ['4783101'],
    'óticas': ['4774100'],
    'lojas de bolsas': ['4789099'],
    'lojas de malas e bolsas': ['4642702', '4789099'],
    'artigos esportivos': ['4763602'],
    'lojas de artigos esportivos': ['4763602'],
    'papelarias': ['4761003', '4789005'],
    'lojas de presentes': ['4789099'],
    'lojas de utilidades domésticas': ['4759801', '4759899'],
    'lojas de eletrônicos': ['4753900'],
    'lojas de informática': ['4751201', '4751202'],
    'lojas de celulares': ['4752100'],
    'assistência técnica de celulares': ['9521500'],
    'lojas de brinquedos': ['4763601'],
    'brinquedos': ['4763601'],
    'lojas de cosméticos': ['4772500', '4789004'],
    'perfumarias': ['4772500'],
    'lojas de produtos naturais': ['4729699'],
    'lojas de suplementos': ['4729699'],
    'tabacarias': ['4729601'],
    'lojas de bebidas': ['4723700'],
    'lojas de departamento': ['4713001', '4713002', '4713004'],
    'lojas de variedades': ['4789099'],
    'armarinhos': ['4755502'],
    'tecidos': ['4755501'],
    'lojas de tecidos': ['4755501'],
    'aviamentos': ['4755502'],

    // ===== LOTE 6 — SAÚDE, BELEZA & BEM-ESTAR =====
    'clínicas médicas': ['8630501', '8630502', '8630503', '8630504', '8630599'],
    'clínicas': ['8630501', '8630502', '8630503', '8630504', '8630599'],
    'consultórios médicos': ['8630501', '8630502', '8630503'],
    'consultórios': ['8630501', '8630502', '8630503', '8630504'],
    'clínicas odontológicas': ['8630504'],
    'consultórios odontológicos': ['8630504'],
    'dentistas': ['8630504'],
    'odontologia': ['8630504'],
    'clínicas veterinárias': ['7500100'],
    'veterinários': ['7500100'],
    'clínicas de fisioterapia': ['8650003'],
    'fisioterapia': ['8650003'],
    'clínicas de psicologia': ['8650002'],
    'psicólogos': ['8650002'],
    'clínicas de nutrição': ['8650004'],
    'nutricionistas': ['8650004'],
    'clínicas de estética': ['9602502'],
    'estética': ['9602502'],
    'centros de estética': ['9602502'],
    'salões de beleza': ['9602501'],
    'cabeleireiros': ['9602501'],
    'barbearias': ['9602501'],
    'manicures e pedicures': ['9602501'],
    'spas': ['9602502', '9609206'],
    'massagens': ['9609206'],
    'academias': ['9313100'],
    'academias de ginástica': ['9313100'],
    'crossfit': ['9313100'],
    'pilates': ['9313100', '8650099'],
    'estúdios de pilates': ['9313100'],
    'yoga': ['9313100'],
    'farmácias': ['4771701', '4771702', '4771703'],
    'drogarias': ['4771701'],
    'farmácias de manipulação': ['4771702'],
    'lojas de produtos veterinários': ['4789004'],
    'pet shops': ['4789004', '9609208'],
    'petshops': ['4789004', '9609208'],
    'banho e tosa': ['9609208'],
    'lojas de cosméticos': ['4772500'],
    'lojas de produtos de beleza': ['4772500'],
    'laboratórios de análises clínicas': ['8640202'],
    'laboratórios': ['8640202', '8640299'],
    'hospitais': ['8610101', '8610102'],
    'home care': ['8712300'],
    'cuidadores': ['8712300', '8800600'],

    // ===== LOTE 7 — EDUCAÇÃO, TECNOLOGIA & MÍDIA =====
    'escolas': ['8513900', '8520100', '8531700'],
    'escolas particulares': ['8513900', '8520100'],
    'escolas de educação infantil': ['8511200', '8512100'],
    'creches': ['8511200'],
    'berçários': ['8511200'],
    'escolas de ensino fundamental': ['8513900'],
    'escolas de ensino médio': ['8520100'],
    'escolas técnicas': ['8531700', '8541400'],
    'cursos profissionalizantes': ['8599604'],
    'cursos livres': ['8599699'],
    'cursos de idiomas': ['8593700'],
    'escolas de idiomas': ['8593700'],
    'escolas de inglês': ['8593700'],
    'autoescolas': ['8599601'],
    'escolas de música': ['8592901'],
    'escolas de dança': ['8592903'],
    'escolas de artes': ['8592999'],
    'reforço escolar': ['8599605'],
    'faculdades': ['8532500', '8533300'],
    'universidades': ['8533300'],
    'desenvolvimento de software': ['6201501', '6201502'],
    'software houses': ['6201501', '6202300'],
    'fábricas de software': ['6201501', '6202300'],
    'desenvolvimento de aplicativos': ['6201501', '6201502'],
    'desenvolvedores': ['6201501', '6201502'],
    'consultoria em ti': ['6204000'],
    'empresas de ti': ['6201501', '6202300', '6204000'],
    'tecnologia da informação': ['6201501', '6202300', '6204000'],
    'suporte técnico': ['9511800'],
    'assistência técnica de informática': ['9511800'],
    'provedores de internet': ['6190601'],
    'hospedagem de sites': ['6311900'],
    'data centers': ['6311900'],
    'agências de marketing': ['7319002'],
    'agências de marketing digital': ['7319002', '6319400'],
    'marketing digital': ['7319002', '6319400'],
    'agências de publicidade': ['7311400'],
    'publicidade e propaganda': ['7311400'],
    'agências de comunicação': ['7311400', '7319002'],
    'assessoria de imprensa': ['7490104'],
    'gráficas': ['1813099', '1813001'],
    'gráficas rápidas': ['1813099'],
    'tipografias': ['1813099'],
    'editoras': ['5811500', '5813100'],
    'fotógrafos': ['7420001'],
    'estúdios fotográficos': ['7420001'],
    'fotografia': ['7420001', '7420004'],
    'filmagem': ['5911101', '5911199'],
    'produtoras de vídeo': ['5911101'],
    'produtoras audiovisuais': ['5911101', '5911199'],
    'web design': ['6201501', '7410202'],
    'design gráfico': ['7410202'],
    'agências de design': ['7410202'],
    'rádios': ['6010100'],
    'emissoras de tv': ['6021700'],
    'jornais': ['5812300'],
    'revistas': ['5813100'],

    // ===== LOTE 8 — TURISMO, EVENTOS & LAZER =====
    'hotéis': ['5510801'],
    'pousadas': ['5510802'],
    'resorts': ['5510803'],
    'motéis': ['5510901'],
    ...
    'albergues': ['5590601'],
    'campings': ['5590602'],
    'agências de viagem': ['7911200'],
    'agências de turismo': ['7911200', '7912100'],
    'operadoras de turismo': ['7912100'],
    'guias de turismo': ['7990200'],
    'buffets': ['5620102'],
    'buffets infantis': ['5620102'],
    'casas de festas': ['5620102', '9329899'],
    'casas de eventos': ['8230002'],
    'organização de eventos': ['8230001', '8230002'],
    'produtoras de eventos': ['8230001', '8230002'],
    'cerimoniais': ['8230002'],
    'locação de equipamentos para festas': ['7729202'],
    'locação de mesas e cadeiras': ['7729202'],
    'aluguel de tendas': ['7729202'],
    'aluguel de brinquedos': ['7729203'],
    'brinquedos infláveis': ['7729203'],
    'parques de diversão': ['9321200'],
    'parques aquáticos': ['9321200'],
    'boliches': ['9329803'],
    'casas de jogos eletrônicos': ['9329802'],
    'salões de jogos': ['9329802'],
    'cinemas': ['5914600'],
    'teatros': ['9001901'],
    'casas de espetáculos': ['9001902'],
    'casas noturnas': ['5611204', '9329801'],
    'baladas': ['9329801'],
    'bares com música ao vivo': ['5611204'],
    'clubes recreativos': ['9311500'],
    'clubes esportivos': ['9311500'],
    'escolinhas esportivas': ['8591100'],
    'centros esportivos': ['9311500'],
    'quadras de esportes': ['9311500'],
    'estádios': ['9311500'],
    'dj e som': ['9001999'],
    'fotografia de eventos': ['7420004'],
    'decoração de festas': ['8230002'],
    'floricultura para eventos': ['4789003'],
    'floriculturas': ['4789003'],
    'locação de carros': ['7711000'],
    'locadoras de veículos': ['7711000'],
    'transporte turístico': ['4929901', '4929902'],
    'fretamento de ônibus': ['4929901'],

    // ===== LOTE 9 — LOGÍSTICA, TRANSPORTE & ATACADO =====
    'transportadoras': ['4930201', '4930202', '4930203'],
    'transporte rodoviário de cargas': ['4930201', '4930202'],
    'transporte de cargas': ['4930201', '4930202', '4930203'],
    'mudanças': ['4930204'],
    'empresas de mudança': ['4930204'],
    'logística': ['5250804', '5250805'],
    'operadores logísticos': ['5250804'],
    'armazéns gerais': ['5211701', '5211799'],
    'armazenagem': ['5211701', '5211799'],
    'depósitos': ['5211799'],
    'centros de distribuição': ['5211701', '5250804'],
    'distribuidoras': ['4639701', '4639702'],
    'distribuidoras de alimentos': ['4639701', '4637107'],
    'distribuidoras de bebidas': ['4635499', '4635401'],
    'distribuidoras de produtos de limpeza': ['4649408'],
    'distribuidoras de cosméticos': ['4646001'],
    'distribuidoras de medicamentos': ['4644301'],
    'atacadistas': ['4639701', '4639702', '4691500'],
    'atacado de alimentos': ['4637107', '4639701'],
    'atacado de bebidas': ['4635401', '4635499'],
    'atacado de produtos de limpeza': ['4649408'],
    'atacado de cosméticos': ['4646001'],
    'atacado de roupas': ['4642701', '4642702'],
    'atacado de calçados': ['4643501'],
    'atacado de papelaria': ['4647801'],
    'atacado de eletrônicos': ['4652400'],
    'atacado de ferragens': ['4672900'],
    'atacado de materiais de construção': ['4679604', '4679699'],
    'atacado de embalagens': ['4686902'],
    'importadoras': ['4691500'],
    'exportadoras': ['4691500'],
    'comércio exterior': ['4691500'],
    'despachantes aduaneiros': ['5250803'],
    'agentes de carga': ['5250801', '5250802'],
    'transporte aéreo de cargas': ['5120000'],
    'transporte marítimo': ['5011402', '5012202'],
    'transporte ferroviário': ['4911600'],
    'courier': ['5320202'],
    'entregas expressas': ['5320202'],
    'motoboys': ['5320202'],
    'serviços de entrega': ['5320202'],
    'last mile': ['5320202'],
    'transporte de cargas perigosas': ['4930203'],
    'transporte de produtos refrigerados': ['4930202'],
    'frigoríficos logística': ['5211702'],
    'estacionamentos': ['5223100'],
    'pátios de veículos': ['5223100'],
  };
  return cnaeMap[seg] || [];
}
