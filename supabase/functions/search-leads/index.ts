...
function generateSearchTerms(segment: string): string[] {
  ...
  const categoryTerms: { [key: string]: string[] } = {
    ...
    'distribuidoras de carnes': ['distribuidora de carnes', 'atacado de carnes', 'atacadista de carnes', 'frigorifico', 'distribuidor de carnes', 'distribuidores de carnes', 'distribuidoras de carnes'],
    ...
    'distribuidoras de queijos': ['distribuidora de queijos', 'queijos atacado', 'laticinios', 'atacadista de queijos', 'distribuidor de queijos', 'distribuidores de queijos', 'distribuidoras de queijos'],
    'distribuidoras de peixes': ['distribuidora de peixes', 'pescado', 'frutos do mar', 'distribuidor de peixes', 'distribuidores de peixes', 'distribuidoras de peixes'],
    'distribuidoras de embutidos': ['distribuidora de embutidos', 'embutidos', 'frios', 'distribuidor de embutidos', 'distribuidores de embutidos', 'distribuidoras de embutidos'],
    ...
    'distribuidoras de chocolates': ['distribuidora de chocolates', 'chocolates atacado', 'chocolate atacado', 'distribuidor de chocolates', 'distribuidores de chocolates', 'distribuidoras de chocolates'],
    'distribuidoras de cosméticos': ['distribuidora de cosmeticos', 'cosmeticos atacado', 'atacadista de cosmeticos', 'distribuidora de cosméticos', 'distribuidor de cosmeticos', 'distribuidores de cosmeticos', 'distribuidoras de cosmeticos'],
    'distribuidoras de perfumes': ['distribuidora de perfumes', 'perfumes atacado', 'atacadista de perfumes', 'distribuidor de perfumes', 'distribuidores de perfumes', 'distribuidoras de perfumes'],
    ...
    'distribuidoras de ferragens': ['distribuidora de ferragens', 'ferragens atacado', 'parafusos atacado', 'distribuidor de ferragens', 'distribuidores de ferragens', 'distribuidoras de ferragens'],
    ...
    'distribuidoras de epi': ['distribuidora de epi', 'epi atacado', 'equipamento de protecao atacado', 'distribuidor de epi', 'distribuidores de epi', 'distribuidoras de epi'],
    ...
    'distribuidoras de utilidades domésticas': ['distribuidora de utilidades domesticas', 'utilidades domesticas atacado', 'utensilios atacado', 'distribuidora de utilidades domésticas', 'distribuidor de utilidades domesticas', 'distribuidores de utilidades domesticas', 'distribuidoras de utilidades domesticas'],
    'distribuidoras de madeiras': ['distribuidora de madeiras', 'madeireira', 'madeira atacado', 'deposito de madeira', 'distribuidor de madeiras', 'distribuidores de madeiras', 'distribuidoras de madeiras'],
    'distribuidoras de material elétrico': ['distribuidora de material eletrico', 'material eletrico atacado', 'eletrica atacado', 'distribuidora de material elétrico', 'distribuidor de material eletrico', 'distribuidores de material eletrico', 'distribuidoras de material eletrico'],
    'distribuidoras de papel': ['distribuidora de papel', 'papel atacado', 'papelao atacado', 'distribuidor de papel', 'distribuidores de papel', 'distribuidoras de papel'],
