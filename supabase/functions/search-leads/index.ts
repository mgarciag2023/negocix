...
function generateSearchTerms(segment: string): string[] {
  ...
  const categoryTerms: { [key: string]: string[] } = {
    ...
    'restaurantes vegetarianos': ['restaurante vegetariano', 'comida vegetariana', 'vegetariano restaurante', 'restaurante natural', 'comida sem carne'],
    ...
    'restaurantes coreanos': ['restaurante coreano', 'comida coreana', 'korean bbq', 'coreano restaurante', 'k-food', 'bbq coreano'],
    ...
    'restaurantes de comida nordestina': ['comida nordestina', 'culinaria nordestina', 'nordestino restaurante', 'culinaria regional nordestina', 'cozinha nordestina'],
    ...
    'casas de sucos': ['casa de sucos', 'sucos naturais', 'sucos naturais loja', 'suco bar', 'juice bar', 'vitaminas e sucos'],
    ...
    'clínicas médicas e odontológicas': ['clinica medica', 'clinica odontologica', 'consultorio medico', 'consultorio odontologico', 'policlinica odonto', 'clinica multipla', 'consultorio medico odonto', 'centro clinico odonto'],
    ...
    'planos de saúde': ['plano de saude', 'operadora de saude', 'convenio medico', 'saude suplementar', 'assistencia medica', 'assistência médica', 'seguro saude', 'seguro saúde'],
    'home care': ['home care', 'atendimento domiciliar', 'enfermagem domiciliar', 'cuidado domiciliar', 'internacao domiciliar', 'internação domiciliar', 'enfermagem em casa', 'saude em casa', 'saúde em casa'],
    ...
    'empresas de engenharia elétrica': ['engenharia eletrica', 'projeto eletrico', 'instalacoes eletricas', 'projeto de eletrica', 'projeto elétrico industrial', 'engenharia de instalacoes eletricas', 'instalacoes eletricas industriais'],
    'montadores de painel elétrico': ['painel eletrico', 'quadro eletrico', 'montagem de paineis', 'paineis eletricos industriais', 'painéis elétricos industriais', 'ccm montagem', 'quadro de comando', 'quadro de distribuicao'],
    ...
    'autopeças de importados': ['autopecas importados', 'pecas importadas', 'pecas carro importado', 'autopecas importadas', 'pecas para importados', 'import car parts', 'autopecas import', 'import car pecas', 'pecas para importado', 'pecas de luxo', 'pecas premium automotivas'],
    'e-commerce de peças automotivas': ['ecommerce autopecas', 'pecas automotivas online', 'loja virtual autopecas', 'autopecas online', 'pecas online', 'autopecas ecommerce', 'pecas online loja', 'site de pecas automotivas'],
    ...
    'lojas de rodas esportivas': ['rodas esportivas', 'rodas automotivas', 'rodas liga leve', 'rodas aro', 'rodas liga', 'loja de rodas', 'centro de rodas', 'house of rodas'],
    ...
    'cooperativas agrícolas': ['cooperativa agricola', 'cooperativa rural', 'cooperativa de produtores', 'cooperativa agro', 'coop agricola'],
    ...
    'lojas de tecidos para decoração': ['tecidos para decoracao', 'tecidos decorativos', 'tecidos decorativos loja', 'loja de cortinas tecidos', 'tecidos para estofado'],
    ...
    'lojas de colchões terapêuticos': ['colchao terapeutico', 'colchao ortopedico', 'colchao magnetico', 'colchao magnetico loja', 'colchao ortopedico loja', 'colchoes terapeuticos', 'colchão terapêutico loja'],
    ...
    'açougues gourmet': ['acougue gourmet', 'boutique de carnes', 'carnes nobres', 'carnes premium', 'casa de carnes premium', 'boutique de carnes gourmet', 'acougue premium', 'açougue premium', 'carnes especiais', 'casa de cortes nobres'],
    ...
    'arenas de beach tennis': ['beach tennis', 'arena de beach', 'quadra de beach', 'arena beach', 'quadra beach tennis', 'clube de beach', 'centro de beach tennis', 'beach arena'],
    'quadras de tênis': ['quadra de tenis', 'tenis', 'clube de tenis'],
    'clubes esportivos': ['clube esportivo', 'clube recreativo', 'clube social', 'associacao esportiva', 'clube social esportivo', 'associacao desportiva', 'associação desportiva', 'centro de lazer', 'clube de campo', 'clube aquatico', 'clube aquático'],
    ...
    'distribuidores de bebidas': ['distribuidora de bebidas', 'deposito de bebidas', 'atacadista de bebidas', 'atacado de bebidas', 'deposito de bebidas atacado', 'depósito de bebidas atacado', 'atacadista de cerveja', 'distribuidor de cerveja', 'distribuidor de refrigerante'],
    ...
    'distribuidoras de alimentos': ['distribuidora de alimentos', 'atacadista de alimentos', 'comercio atacadista de produtos alimenticios', 'generos alimenticios', 'atacadista alimenticio', 'atacadista alimentício', 'comercio atacadista alimentar', 'distribuidor de mantimentos'],
    ...
    'distribuidoras de ovos': ['distribuidora de ovos', 'ovos atacado', 'granja distribuidora', 'atacadista de ovos', 'granja de ovos atacado', 'distribuidor de ovos de galinha', 'ovos para revenda'],
    ...
    'locadoras de veículos': ['locadora de veiculos', 'aluguel de carros', 'rent a car', 'locacao de carros', 'locação de carros', 'locadora de carros', 'rental car', 'aluguel de veiculos', 'locacao de frotas', 'locação de frotas'],
    'empresas de motoboy': ['motoboy', 'motofrete', 'entrega moto'],
    'frotistas': ['frotista', 'frota', 'gestao de frota'],
    'empresas com frota própria': ['frota propria', 'frota corporativa', 'gestao de frotas', 'gestão de frotas', 'frota de veiculos', 'frota de veículos'],
    'vans escolares': ['van escolar', 'transporte escolar', 'transporte de alunos', 'van para escola', 'transporte coletivo escolar'],
    ...
    'empresas de desenvolvimento de software': ['desenvolvimento de software', 'software house', 'fabrica de software', 'dev house', 'tech company', 'empresa de tecnologia', 'startup de software', 'programacao sob demanda', 'programação sob demanda'],
    ...
    'empresas de portaria remota': ['portaria remota', 'portaria virtual', 'portaria automatizada', 'portaria inteligente', 'controle de acesso remoto'],

    // ===== MARKETING E PUBLICIDADE =====
    'agências de marketing digital': ['agencia de marketing', 'marketing digital', 'agencia digital', 'digital agency', 'agencia de performance', 'agência de performance', 'marketing online empresa', 'gestao de trafego', 'gestão de tráfego'],
    ...
    'agências de mídias sociais': ['midias sociais', 'redes sociais', 'social media', 'gestao de redes sociais', 'gestão de redes sociais', 'social media marketing', 'agencia de social', 'agência de social'],
    ...
    // ===== EVENTOS =====
    'agência de eventos': ['agencia de eventos', 'organizadora de eventos', 'produtora de eventos', 'buffet e eventos', 'eventos corporativos empresa', 'empresa de eventos', 'promotora de eventos', 'gestora de eventos', 'producao de eventos', 'produção de eventos'],
    'buffets de festas': ['buffet de festas', 'buffet infantil', 'espaco para eventos', 'salao de festas', 'buffet eventos', 'espaco infantil', 'espaço infantil', 'casa de festas buffet', 'buffet casamento', 'buffet corporativo', 'espaco de eventos', 'espaço de eventos'],
    'casas de festas': ['casa de festas', 'salao de festas', 'espaco para eventos', 'espaco de festas', 'espaço de festas', 'chacara de festas', 'chácara de festas', 'sitio de festas', 'sítio de festas', 'espaco evento', 'espaço evento'],
    'empresas de locação de materiais para eventos': ['locacao de materiais', 'mesas e cadeiras', 'toalhas para eventos', 'locacao de mesas', 'locação de mesas', 'aluguel de cadeiras', 'locacao de tendas', 'locação de tendas', 'aluguel para festas'],
    ...
    'lojas de artigos para bebê': ['artigos para bebe', 'loja de bebe', 'enxoval de bebe', 'baby shop', 'bebe store', 'bebê store', 'mundo do bebe', 'mundo do bebê', 'boutique de bebe', 'boutique de bebê'],
    ...
    'lojas de veículos elétricos': ['veiculos eletricos', 'patinete eletrico', 'bicicleta eletrica', 'patinete eletrico loja', 'bicicleta eletrica loja', 'mobilidade eletrica', 'mobilidade elétrica', 'bike eletrica'],
    ...
    // ===== ENGENHARIA =====
    'empresas de engenharia mecânica': ['engenharia mecanica', 'projeto mecanico', 'projetos mecanicos empresa', 'consultoria mecanica', 'engenharia de maquinas'],
    'empresas de engenharia ambiental': ['engenharia ambiental', 'meio ambiente', 'licenciamento ambiental', 'consultoria ambiental', 'gestao ambiental', 'gestão ambiental', 'estudo de impacto ambiental'],
    ...
    'escolas particulares': ['escola particular', 'colegio particular', 'escola privada', 'colegio privado', 'colégio privado', 'instituicao de ensino privada', 'instituição de ensino privada'],
    ...
    'cabeleireiros infantis': ['cabeleireiro infantil', 'salao infantil', 'salao kids', 'salão kids', 'hair kids', 'corte infantil', 'cabeleireiro kids', 'barbearia infantil'],
    'espaços de beleza': ['espaco de beleza', 'beauty center', 'centro de beleza', 'studio beauty', 'beauty studio', 'beleza studio', 'studio beleza', 'salao beauty', 'salão beauty'],
    ...
    'hotéis fazenda': ['hotel fazenda', 'fazenda hotel', 'turismo rural', 'fazenda turistica', 'fazenda turística', 'turismo rural hotel', 'pousada rural', 'hotel rural'],
    'motéis': ['motel'],
    ...
    'casas de show': ['casa de show', 'casa de espetaculos', 'espaco de shows', 'espaço de shows', 'palco para eventos', 'casa de eventos musicais', 'venue musical'],
    'cinemas': ['cinema', 'multiplex', 'sala de cinema'],
    'parques aquáticos': ['parque aquatico', 'toboagua', 'piscinas'],
    'parques de diversões': ['parque de diversoes', 'parque tematico', 'parque de aventuras', 'parque recreativo', 'entretenimento familiar'],
    'pesque e pague': ['pesque e pague', 'pesqueiro', 'pesca'],
    'bowling': ['bowling', 'boliche'],
    'karting': ['karting', 'kart', 'kartódromo'],
    'escape rooms': ['escape room', 'sala de fuga', 'sala de escape', 'jogo de fuga', 'escape game', 'adventure room'],
    ...
    'beneficiadoras de café': ['beneficiadora de cafe', 'beneficiamento de cafe', 'beneficiamento de cafe industrial', 'torrefacao e beneficiamento', 'cooperativa de cafe'],
    ...
    'lojas de artigos religiosos': ['artigos religiosos', 'loja religiosa', 'imagenes sacras', 'loja sacra', 'artigos sacros', 'loja de santos', 'imagenes religiosas'],
    ...
    'lojas de placas solares': ['placas solares', 'painel solar', 'energia solar', 'energia solar loja', 'fotovoltaica loja', 'sistema fotovoltaico', 'kit solar'],
    ...
    'empresas de transporte refrigerado': ['transporte refrigerado', 'caminhao frigorifico', 'transporte de congelados', 'frigorifico sobre rodas', 'frigorífico sobre rodas', 'logistica refrigerada', 'logística refrigerada', 'caminhao refrigerado', 'caminhão refrigerado'],
    ...
    'empresas de transporte escolar': ['transporte escolar', 'van escolar', 'van de transporte escolar', 'micro onibus escolar', 'micro ônibus escolar'],

    // ===== ESCOLAS FALTANTES =====
    'escolas bilíngues': ['escola bilingue', 'educacao bilingue', 'escola internacional', 'escola bilingual', 'colegio bilingue', 'colégio bilíngue', 'ensino bilingue', 'school bilingual'],
    ...
    'dark kitchens': ['dark kitchen', 'cozinha fantasma', 'cloud kitchen', 'ghost kitchen', 'kitchen fantasma', 'virtual kitchen', 'cozinha virtual', 'delivery only', 'restaurante virtual'],
    'casas de chá': ['casa de cha', 'cha', 'tea house'],
    'cafés especiais': ['cafe especial', 'cafe gourmet', 'specialty coffee', 'coffee shop gourmet', 'micro torrefacao', 'micro torrefação', 'cafe artesanal', 'café artesanal'],
    ...
    'restaurantes mediterrâneos': ['restaurante mediterraneo', 'comida mediterranea', 'mediterraneo restaurante', 'comida grega italiana', 'cozinha mediterranea'],
    'restaurantes de comida libanesa': ['comida libanesa', 'restaurante libanes', 'culinaria arabe', 'libanes restaurante', 'culinaria libanesa', 'esfiha e quibe'],
    ...
    'lojas de chocolates belgas': ['chocolates belgas', 'chocolates importados', 'chocolate premium', 'chocolatier premium', 'loja de chocolates finos', 'chocolate artesanal premium'],
    'importadoras de vinhos': ['importadora de vinhos', 'vinhos importados', 'wine importer', 'vinhos importados loja', 'wine shop importados', 'adega de importados'],
    ...
    'fábricas de pão de queijo': ['fabrica de pao de queijo', 'pao de queijo', 'pao de queijo industrial', 'pão de queijo industrial', 'fabrica de pao de queijo mineiro'],
    ...
    'ateliês de alta costura': ['alta costura', 'haute couture', 'sob medida', 'atelie exclusivo', 'ateliê exclusivo', 'moda exclusiva', 'costura fina', 'roupa sob medida'],
    ...
    'empresas de representação comercial': ['representacao comercial', 'representante comercial', 'rep comercial', 'representante de vendas', 'rep de vendas', 'representacao de produtos'],
    'empresas de pesquisa de mercado': ['pesquisa de mercado', 'instituto de pesquisa', 'market research', 'analise de mercado', 'análise de mercado', 'inteligencia de mercado', 'inteligência de mercado'],
    ...
    // ===== VET FALTANTES =====
    'clínicas veterinárias de grandes animais': ['veterinario de grandes animais', 'veterinario rural', 'veterinaria equina', 'veterinario equino', 'veterinário equino', 'veterinario bovino', 'vet rural', 'clinica vet rural'],
    'farmácias veterinárias': ['farmacia veterinaria', 'produtos veterinarios', 'medicamento animal', 'agro vet farmacia', 'loja vet medicamentos', 'produtos vet farmacia'],
    'hospitais veterinários': ['hospital veterinario', 'emergencia animal', 'uti animal', 'pronto socorro animal', 'emergencia veterinaria', 'emergência veterinária', 'hospital vet', 'internacao animal'],
    'laboratórios veterinários': ['laboratorio veterinario', 'exames veterinarios', 'lab vet', 'diagnostico veterinario', 'diagnóstico veterinário', 'patologia veterinaria'],
    ...
    'laboratórios de manipulação': ['laboratorio de manipulacao', 'manipulacao farmaceutica', 'farmacia de manipulacao lab', 'lab de manipulacao', 'manipulacao magistral'],
    ...
    'distribuidoras de higiene e limpeza': ['distribuidora de higiene', 'limpeza atacado', 'produtos de limpeza atacado', 'higiene e limpeza', 'distribuidor de produtos de higiene', 'atacado de limpeza e higiene', 'atacadista de material de limpeza'],
