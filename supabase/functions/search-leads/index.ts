...
function generateSearchTerms(segment: string): string[] {
  ...
  const categoryTerms: { [key: string]: string[] } = {
    ...
    'distribuidores de colchões': ['distribuidora de colchoes', 'colchoes atacado', 'distribuidora de colchões', 'distribuidor de colchoes', 'distribuidores de colchoes', 'distribuidoras de colchoes'],
