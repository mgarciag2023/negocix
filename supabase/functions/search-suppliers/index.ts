...
const productSearchTerms: { [key: string]: string[] } = {
  ...
  "Construção Metálica": ["construcao metalica", "estrutura metalica", "galpao metalico", "edificacao metalica", "pre-fabricado metalico", "steel frame", "estruturas em aco"],
  "Estruturas Metálicas": ["estruturas metalicas", "estrutura metalica", "serralheria industrial", "galpao metalico", "caldeiraria", "vigas metalicas", "perfis metalicos"],
  "Perfis e Chapas de Aço": ["perfis de aco", "chapas de aco", "aco laminado", "aco galvanizado", "distribuidora de aco", "siderurgica"],
  "Telhas Metálicas": ["telhas metalicas", "telha metalica", "telha galvanizada", "telha sanduiche", "telha termoacustica", "cobertura metalica"],
