  ...
  if (step === "home") {
    ...
    return (
      <div className="min-h-screen overflow-x-hidden w-full max-w-[100vw] flex flex-col">
        ...
        {lockDialog}
        {/* Hero */}
        <div className="relative bg-gradient-hero flex items-start justify-center min-h-screen">
          ...
          <div className="relative z-10 text-center px-6 max-w-lg mx-auto flex flex-col items-center pt-20">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 mb-6 opacity-0 animate-fade-in-up">
