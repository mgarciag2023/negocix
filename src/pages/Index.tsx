          ...
          <div className="container mx-auto px-4">
            <div className="grid gap-8 md:grid-cols-3">
              <div className="text-center">
                ...
                <h3 className="mb-2 text-xl font-bold text-foreground">IA Inteligente</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="mb-2 text-xl font-bold text-foreground">Alta Precisão</h3>
                <p className="text-muted-foreground">
              ...
              <div className="text-center">
                ...
                <h3 className="mb-2 text-xl font-bold text-foreground">Aumente Vendas</h3>
                <p className="text-muted-foreground">
